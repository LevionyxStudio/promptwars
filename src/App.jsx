...
export default function App() {
  ...
  // 1. Firebase Auth State Listener (ongoing session persistence)
  useEffect(() => {
    let isMounted = true;
    console.log('[Guardian Auth] 🏁 App mounted. Registering onAuthStateChanged listener...');
  ...
  if (!user) {
    return <LoginScreen onLoginSuccess={(signedInUser) => setUser(signedInUser)} />;
  }
