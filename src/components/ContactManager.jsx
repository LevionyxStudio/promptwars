...
import { UserPlus, Phone, Mail, User, Trash2, CheckCircle2, ShieldCheck, HeartHandshake } from 'lucide-react';
...
export default function ContactManager({ contacts, onAddContact, onDeleteContact, onSelectPrimary }) {
  ...
  const handleSubmit = (e) => {
    ...
    onAddContact({
      ...
      email: email.trim() || 'emergency@guardiansafety.app',
  ...
  return (
    <div className="glass-panel p-5 sm:p-6 border border-slate-800 bg-slate-900/60 rounded-2xl">
      ...
      {/* Add Contact Form */}
      {showAddForm && (
        <form onSubmit={handleSubmit} className="mb-5 p-4 rounded-xl bg-slate-950/80 border border-emerald-500/30 space-y-3.5 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-700 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-700 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500 font-mono"
              />
            </div>
